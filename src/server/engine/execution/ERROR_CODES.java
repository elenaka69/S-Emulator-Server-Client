...
public class ERROR_CODES {
    ...
    public static final int ERROR_PROGRAM_EXISTS = -2;
    public static final int ERROR_FUNCTION_MISSING = -3;
    public static final int ERROR_PROGRAM_WO_INSTRUCTIONS = -4;
    public static final int ERROR_USER_NOT_FOUND = -5;
    public static final int ERROR_PROGRAM_NOT_FOUND = -6;
    public static final int ERROR_FUNCTION_NOT_FOUND = -7;
    public static final int ERROR_EXECUTION_FAILED = -8;
    public static final int ERROR_NOT_ENOUGH_CREDIT = -9;
