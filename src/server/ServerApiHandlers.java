...
public class ServerApiHandlers {
    ...
    protected BaseResponse handleApi(BaseRequest req)
    {
        ...
        response = switch (req.action) {
            ...
            case "runProgram" -> handleRunProgram(req);
    ...
    protected BaseResponse handleLogin(BaseRequest req) {
    ...
    protected BaseResponse handleLogout(BaseRequest req) {
        String username = getString(req, "username");
        if (!validateParameter(username)) {
            return new BaseResponse(false, "Invalid username");
        }
    ...
    protected BaseResponse handleRemoveUser(BaseRequest req) {
        String username = getString(req, "username");
        if (!validateParameter(username)) {
            return new BaseResponse(false, "Invalid username");
        }
    ...
    protected BaseResponse handleGetCredits(BaseRequest req) {
        String username = getString(req, "username");
    ...
    protected BaseResponse handleGetDegreeProgram(BaseRequest req) {
        String username = getString(req, "username");
    ...
    protected BaseResponse handleChargeCredits(BaseRequest req) {
        String username = getString(req, "username");
    ...
    protected BaseResponse handleGetUsers(BaseRequest req) {
    ...
    protected BaseResponse handleUserStatistics(BaseRequest req) {
        String username = getString(req, "username");
        if (!validateParameter(username)) {
            return new BaseResponse(false, "Invalid username");
        }
    ...
    protected BaseResponse handleUploadFile(BaseRequest req) {
        String username = getString(req, "username");
    ...
    protected BaseResponse handlePrograms(BaseRequest req) {
    ...
    protected BaseResponse handleFunctions(BaseRequest req) {
    ...
    protected BaseResponse handleFunctionsList(BaseRequest req) {
    ...
    protected BaseResponse handleSubFunctionsList(BaseRequest req) {
    ...
    protected BaseResponse handleSendMessage(BaseRequest req) {
        String username = getString(req, "username");
    ...
    protected BaseResponse handleGendMessage(BaseRequest req) {
    ...
    protected BaseResponse handleExecuteProgram(BaseRequest req) {
        String username = getString(req, "username");
        String programName = getString(req, "programName");
    ...
    protected BaseResponse handleGetInstructions(BaseRequest req) {
        String username = getString(req, "username");
        if (!validateParameter(username)) {
            return new BaseResponse(false, "Invalid username");
        }
    ...
    protected BaseResponse handleGetInstructionHistory(BaseRequest req) {
        String username = getString(req, "username");
    ...
    protected BaseResponse handleGetProgramFunctions(BaseRequest req) {
        String programName = getString(req, "programName");
        String username = getString(req, "username");
    ...
    protected BaseResponse handleSetWokFunctionUser(BaseRequest req) {
        String username = getString(req, "username");
        String funcName = getString(req, "funcName");
    ...
    protected BaseResponse handleGetHighlightOptions(BaseRequest req) {
        String username = getString(req, "username");
        if (!validateParameter(username))
            return new BaseResponse(false, "Invalid username");
    ...
    protected BaseResponse handleExpandProgram(BaseRequest req) {
        String username = getString(req, "username");
        if (!validateParameter(username))
            return new BaseResponse(false, "Invalid username");
    ...
    protected BaseResponse handleCollapseProgram(BaseRequest req) {
        String username = getString(req, "username");
        if (!validateParameter(username))
            return new BaseResponse(false, "Invalid username");
    ...
    protected BaseResponse handleGetProgramInputVariables(BaseRequest req) {
        String username = getString(req, "username");
        if (!validateParameter(username))
            return new BaseResponse(false, "Invalid username");
    ...
    protected BaseResponse handleRunProgram(BaseRequest req) {
        String username = getString(req, "username");
    ...
    protected BaseResponse handleGetRunStatistic(BaseRequest req) {
        String username = getString(req, "username");
        if (!validateParameter(username))
            return new BaseResponse(false, "Invalid username");
    ...
    protected BaseResponse handleDeductCredits(BaseRequest req) {
        String username = getString(req, "username");
    ...
    private boolean validateParameter(Integer param) {
        return (param != null);
    }

    private boolean validateParameter(Boolean param) {
        return (param != null);
    }

    private String getString(BaseRequest req, String key) {
        Object val = req.data.get(key);
        return val instanceof String ? (String) val : null;
    }

    private Integer getInt(BaseRequest req, String key) {
        Object val = req.data.get(key);
        return val instanceof Number ? ((Number) val).intValue() : null;
    }

    private Boolean getBoolean(BaseRequest req, String key) {
